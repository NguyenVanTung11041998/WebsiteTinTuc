...
using WebsiteTinTuc.Admin.Authentication.JwtBearer;
...
namespace WebsiteTinTuc.Admin
{
    ...
    public class AdminWebCoreModule : AbpModule
    {
        ...
        public AdminWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PostInitialize()
        {
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(AdminWebCoreModule).Assembly);
        }
    }
}
