...
namespace WebsiteTinTuc.Admin.Migrations
{
    ...
    [Migration("20200627164628_InitTinTucDb")]
    partial class InitTinTucDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebsiteTinTuc.Admin.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebsiteTinTuc.Admin.Entities.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebsiteTinTuc.Admin.Entities.PostCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebsiteTinTuc.Admin.Entities.PostHashtag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("WebsiteTinTuc.Admin.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("WebsiteTinTuc.Admin.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("WebsiteTinTuc.Admin.Entities.Asset", b =>
                {
                    b.HasOne("WebsiteTinTuc.Admin.Entities.Post", null)
                        .WithMany("Assets")
            ...
            modelBuilder.Entity("WebsiteTinTuc.Admin.Entities.PostCategory", b =>
                {
                    b.HasOne("WebsiteTinTuc.Admin.Entities.Category", "Category")
