<template>
  <div>
    ...
    <div class="row content-company-prominent">
      ...
      <div class="col-lg-2">
        <div
          class="row image-thumbnail"
          v-for="item in prominentCompanies"
          :key="item.id"
        >
          <img :src="getLinkPath(item.thumbnail)" :alt="item.name" />
        </div>
      </div>
      <div class="col-lg-4">
        <div class="row">
          <div class="col-lg-12">
            <div class="boder-post-prominent">
              <div class="row" v-for="item in prominentPosts" :key="item.id">
                <div class="col-lg-8">
